...
2. The code in the file [random-quotes.js](/random-quotes.js) when executed, prints out a random quote from an object that contains quotes as values and number indexes as keys. We will want you to make some changes to the code to only print out quotes whose key is not an even number.
